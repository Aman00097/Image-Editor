      ...
      <main>
        <div className={`container ${!img ? "disable" : ""}`}>
          ...
          <div className="content">
            <div className="image">
              <img src={img ? URL.createObjectURL(img) : "image-placeholder.svg"} alt="img" />
            </div>
            <div class="editor_panel">
              <div class="filter">
                <label>Filters</label>
                <div class="options">
                  <button id="brightness" class={filterBtn === "Brightness" ? "active" : ""} onClick={imgFilter}>Brightness</button>
                  <button id="saturation" class={filterBtn === "Saturation" ? "active" : ""} onClick={imgFilter}>Saturation</button>
                  <button id="inversion" class={filterBtn === "Inversion" ? "active" : ""} onClick={imgFilter}>Inversion</button>
                  <button id="grayscale" class={filterBtn === "Grayscale" ? "active" : ""} onClick={imgFilter}>Grayscale</button>
                </div>
                <div class="slider">
                  <div class="filter_info">
                    <span class="name">{filterBtn}</span>
